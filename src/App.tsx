...
import { PdfLoader, PdfHighlighter, Highlight, Popup, AreaHighlight, Tip } from 'react-pdf-highlighter'
    ...
    <div style={styles.sidebar}>
      <div style={styles.sidebarContent}>
        <div style={styles.contents}>
          ...
          {selectedContent && (
            <div style={styles.selectedText}>{selectedContent}</div>
          )}
          {selectedComment && (
            <>
...
const LeftSidebar = ({
  ...
  return (
    <div style={styles.getLeftSidebarStyle(isOpen)}>
...
function App() {
  ...
  const addHighlight = (highlight: NewHighlight) => {
    setHighlights(prev => [
      { ...highlight, id: String(Math.random()).slice(2) },
      ...prev
    ])
  }
